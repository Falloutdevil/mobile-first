        ...
        <div>
            <div className={s.photographerDataInner}>
                ...
                <p className={s.photographerText}>Всем привет! Я фотограф Мария! И по мимо
                    ...
                    <p className={s.photographerTextTwo}>Сначала мы (я и моя команда) изучаем интересы клиентов, а затем придумываем подходящее решение,
                ...
                <span className={s.photographerSubTitle}>Что я предоставлю:</span>
                <p className={s.photographerText}>Встречу вас на машине после длительного перелёта.
